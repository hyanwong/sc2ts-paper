...
class D3ARG_viz:
    def __init__(self, ts, df, lineage_defining_muts):
        self.ts = ts
        self.df = df
        ...
        self.pango_lineage_samples = df.groupby(Pango)['node_id'].apply(list).to_dict()
